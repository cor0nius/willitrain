...
func TestMain(m *testing.M) {
	...
	dbURL = fmt.Sprintf("postgres://user:secret@docker:%s/testdb?sslmode=disable", pgResource.GetPort("5432/tcp"))
	...
	redisURL = fmt.Sprintf("redis://docker:%s", redisResource.GetPort("6379/tcp"))
